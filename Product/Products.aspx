...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button CssClass="addBtn" ID="addProdBtn" runat="server" Text="Add New Product" PostBackUrl="~/Product/AddProducts.aspx" />
            ...
            <div class="productGridView">
                <asp:GridView CssClass="gridCls" ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id"  ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
