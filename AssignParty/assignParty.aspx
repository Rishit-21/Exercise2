...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button CssClass="addBtn" ID="addAssignBtn" runat="server" Text="Assign New Party" PostBackUrl="~/AssignParty/AddAssign.aspx" />
            ...
            <div class="assignGridView">
                <asp:GridView CssClass="gridCls" ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="assignId" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
