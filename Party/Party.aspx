...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button CssClass="addBtn" ID="addPrtyBtn" runat="server" Text="Add Party" PostBackUrl="~/Party/AddParty.aspx"  />
        ...
        <div class="gridView">
             <asp:GridView CssClass="gridCls" ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="id"  OnRowCommand="GridView1_RowCommand" >
